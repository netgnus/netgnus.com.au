...
With Gemini 3.1 Flash's `imageSize: "4K"` option, many traditional upscaling
post-processing steps are no longer necessary. If your target platform accepts
images at or below 4K resolution, generate at native 4K instead of upscaling.
